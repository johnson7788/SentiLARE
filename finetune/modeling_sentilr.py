# PyTorch BERT model.
# This code is modified based on modeling_bert.py in pytorch-transformers.
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None, pos_ids=None,
                senti_word_ids=None, polarity_ids=None):
